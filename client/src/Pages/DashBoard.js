    ...
    <div>
      <div className="lg:grid lg:grid-cols-5 h-screen font-lexend overflow-y-scroll overflow-x-clip">
        <div className="col-span-1 p-4 bg-rp-black text-jp-yellow">
          <div className="lg:inline flex justify-between">
            <Link to="/">
        ...
        <div
          ...
          className={isMobile ? "hidden bg-mj-yellow" : "inline bg-mj-yellow"}
        >
            ...
            <ul className="">
              ...
              <Link to="/dashboard/analysis">
                <li
                  ...
                  className={
                    active === "2"
                      ? "text-mj-yellow flex text-2xl p-2 pt-4"
                      : "text-mj-yellow flex text-2xl p-2 pt-4"
                  }
                >
                  <span className="mx-4">
              ...
              <li>
              <div className="lg:hidden block mx-4 py-4">
          <button
        ...
        <div className=" lg:block absolute bottom-14 z-50 right-5 lg:bottom-10 lg:left-16 lg:right-0">
          <button
